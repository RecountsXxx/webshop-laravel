                ...
                <form action="{{route('product.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="price" required class="form-control" id="price" placeholder="Enter product price">
                            <label for="description">Description</label>
                            <input type="text" name="description" required class="form-control" id="description" placeholder="Enter product description">
                            ...
                            <input type="text" name="new_price" class="form-control" id="new_price" placeholder="Enter new price(discount)">
